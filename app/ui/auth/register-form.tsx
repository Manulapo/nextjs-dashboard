...
import { registerUser, State } from '@/app/actions/authenticateActions';
import { Button } from '@/app/ui/misc/button';
import { ArrowRightIcon } from '@heroicons/react/20/solid';
import { AtSymbolIcon, ExclamationCircleIcon, KeyIcon, UsersIcon } from '@heroicons/react/24/outline';
import { useActionState } from 'react';
import { lusitana } from '../fonts';

export default function RegisterForm() {
    const initialState: State = { message: null, errors: {} };
    const [error, formAction, isPending] = useActionState(registerUser, initialState);
